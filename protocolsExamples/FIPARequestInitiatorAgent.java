...
/**
 * This example shows how to implement the initiator role in a FIPA-request
 * interaction protocol. In this case in particular we use an
 * <code>AchieveREInitiator</code> ("Achieve Rational effect") to request a
 * dummy action to a number of agents (whose local names must be specified as
 * arguments).
 * 
